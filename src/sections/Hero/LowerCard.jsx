...
function LowerCard() {
  return (
    <div className="transition-all	   font-bold  lower-card max-lg:gap-10  -mt-24 flex flex-wrap justify-center items-center gap-8 z-[100000] bottom-[-10%] w-full ">
      <div className="card relative gap-5 rounded-xl shadow-md hover:text-white group       hover:bg-[#6721AB]	 max-lg:w-[40%] max-md:w-[80%] z-[100] overflow-hidden w-[190px] p-10 px-16 flex flex-col justify-center items-center  bg-white">
