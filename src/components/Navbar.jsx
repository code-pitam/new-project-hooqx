...
function Navbar() {
  ...
  return (
    <>
      <div className="text-white  navbar transition-all     text-md   font-bold fixed top-0 w-full z-[900]  flex justify-between pr-4 items-center filter backdrop-blur-lg ">
